...
<template>
  <div class="text-end">
    <BaseButton @click="next()" size="icon" variant="outline">
      <svg viewBox="0 0 15 15" width="1.2em" height="1.2em" class="w-[20px] h-[20px] text-foreground"
           v-if="state === 'light'">
      ...
      <svg viewBox="0 0 15 15" width="1.2em" height="1.2em" class="w-[20px] h-[20px] text-foreground" v-else>
        <path fill="currentColor" fill-rule="evenodd"
